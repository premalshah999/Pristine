  ...
  return (
    <>
        ...
        <div className="mx-auto w-full max-w-[var(--container-page)] px-6">
          <Reveal>
            ...
            <p className="lede mt-8 max-w-[60ch]">
              ...
              assessment, interpretation, nutrition, behavior change, and the
            ...
            <p className="mt-5 max-w-[68ch] text-[0.88rem] leading-relaxed text-[var(--color-ink-muted)]">
              ...
              final plan depends on intake, goals, safety, budget, current
              care, and clinical fit. Specific tests, supplement choices, and
              protocol details are discussed privately only when relevant.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="pb-24">
        ...
        >
          {services.map((s, i) => {
            const publicDetails = getPublicServiceDetails(s.slug);
