...
export const testimonialStories: TestimonialStory[] = [
  {
    ...
    condition: "Thyroid",
    hook: "Thyroid support after years of normal-range labs.",
    quote:
      "I had been told to wait because my TSH was technically in range. Megha looked at antibodies, ferritin, stress load, protein intake, and my symptoms together. For the first time, the plan matched what I was feeling.",
  ...
  },
  {
    ...
    hook: "Weight resistance with sleep, cravings, and cycle changes in the picture.",
    quote:
      "The first thing Megha did was stop making this about willpower. We mapped sleep, cycle changes, protein, insulin clues, and late-day cravings. I stopped skipping meals and started seeing patterns I could actually work with.",
  ...
  },
  {
    ...
    condition: "Functional weight loss",
    hook: "Consistent workouts, uneven recovery, and post-dinner glucose spikes.",
    quote:
      "I thought I needed a harder plan. Megha showed me that my post-dinner glucose, sleep debt, and under-eating during the day were driving the night cravings. The changes were simple enough to repeat.",
    href: "/conditions/functional-weight-loss",
  ...
  },
  {
    ...
    hook: "Migraines that looked random until timing and triggers were mapped.",
    quote:
  ...
  },
  {
    ...
    condition: "Hormones",
    hook: "Old PCOS patterns and midlife weight regain reviewed together.",
    quote:
  ...
  },
  {
    ...
    hook: "Bloating and constipation treated as part of the whole pattern.",
    quote:
    ...
    href: "/conditions/gut-dysfunction",
  ...
  },
  {
    ...
    hook: "Tingling reviewed alongside glucose history and nutrient status.",
    quote:
  ...
  },
  {
    ...
    hook: "Anxiety support that included blood sugar, sleep, and caffeine timing.",
    quote:
